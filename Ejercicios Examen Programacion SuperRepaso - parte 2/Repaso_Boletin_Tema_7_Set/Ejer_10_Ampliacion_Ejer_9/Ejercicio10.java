...
static Scanner sc = new Scanner(System.in);
	...
	public static void main(String[] args) {
		...
		SortedSet<String> palabras = new TreeSet<String>(new Comparador_Longitud_Palabras());
		int opcion;
 ...
 * si no, se eleva una excepción de tipo IllegalArgumentException que se debe capturar. */
	public static void mostrarSubconjunto(SortedSet<String> palabras) {
		...
		try {
			Comparador_Longitud_Palabras comparator = new Comparador_Longitud_Palabras();
			
			if(comparator.compare(palabra1, palabra2) > 0) { //es decir, que fuesen iguales
