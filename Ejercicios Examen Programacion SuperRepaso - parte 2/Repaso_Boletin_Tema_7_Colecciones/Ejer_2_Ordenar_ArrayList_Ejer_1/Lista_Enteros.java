...
public class Lista_Enteros {
	...
	public void ordenarEnteros() { //el método en la clase "lista/conjunto" que complementa al método compareTo de la clase principal
		Collections.sort(this.getLista_enteros());
	}
