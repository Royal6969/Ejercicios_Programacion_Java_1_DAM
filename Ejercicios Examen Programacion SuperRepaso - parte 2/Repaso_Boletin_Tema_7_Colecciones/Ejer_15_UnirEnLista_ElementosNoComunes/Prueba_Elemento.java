...
public class Prueba_Elemento {
	...
	public static void unirEnUnaLista(Lista_Elementos lista1, Lista_Elementos lista2) {
		...
		for(int i=0; i<lista1.getLista_elementos().size(); i++) {
			...
			if(buscarNumeroDiferente(lista2.getLista_elementos(), lista1.getLista_elementos().get(i).getNum()) == true) {
				listaCompleta.getLista_elementos().add(lista1.getLista_elementos().get(i).getNum());
			}
		}
		for(int i=0; i<lista2.getLista_elementos().size(); i++) {
			if(buscarNumeroDiferente(lista1.getLista_elementos(), lista2.getLista_elementos().get(i).getNum()) == true) {
	...
	//para buscar un numero de la lista1 que no esté en la lista2
	public static boolean buscarNumeroDiferente(Lista_Elementos listaAUX, Elemento num) { //creo en los parámetros una listaAUX y un Elemento aux
