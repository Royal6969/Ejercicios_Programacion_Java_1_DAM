...
/*7. Se plantea desarrollar un programa Java que permita la gestión de una empresa agroalimentaria 
 ...
 * Los productos congelados por nitrógeno deben llevar la información del método de congelación empleado 
 * y del tiempo de exposición al nitrógeno expresada en segundos
 */

//Crear el código de las clases Java implementando una relación de herencia siguiendo estas indicaciones:

/*a) En primer lugar realizar un esquema con papel y bolígrafo 
 * donde se represente cómo se van a organizar las clases cuando escribamos el código. 
 ...
 * para agrupar atributos y métodos cuando sea posible. Esto corresponde a “realizar abstracciones” 
 * en el ámbito de la programación, que pueden o no corresponderse con el mundo real.
 */
...
/*Crear una clase TestHerencia con el método main donde se creen: dos productos frescos, 
 * tres productos refrigerados y cinco productos congelados 
 * (2 de ellos congelados por agua, otros 2 por aire y 1 por nitrógeno). 
